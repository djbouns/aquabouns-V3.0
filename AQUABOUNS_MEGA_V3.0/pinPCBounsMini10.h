...
const uint8_t pinOutRelaisRefuge = A11; // relais refuge // ouvert = off
const uint8_t pinOutRelaisRemplissageReserve = A12; // relais ou electrovanne pour remplissage reserve
const uint8_t pinOutRAC = A13; // relais ou electrovanne pour RAC
...
const uint8_t pinOutEclairage[4] {8, 9, 10 , 11}; // sortie PWM eclairage Couleur1, color2, Couleur1, color2
const uint8_t pinInFlotteurGodetEcumeur = 24; // entree flotteur godet ecumeur (ferme = ON)
const uint8_t pinInFlotteurReserveBas = 25; // entree flotteur niveau bas reserve d'eau (ferme si niveau bas reserve d'eau osmose)
const uint8_t pinInFlotteurOsmolation = 26; //  entree flotteur osmolation (ferme = ON)
...
const uint8_t pinInFlotteurReserveHaut = 29; // entree flotteur disponible, non utilisé pour le momment
