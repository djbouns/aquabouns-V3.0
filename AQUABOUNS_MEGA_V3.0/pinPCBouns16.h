...
const uint8_t pinOutRelaisRefuge = A13; // relais refuge // ouvert = off
const uint8_t pinOutRelaisRemplissageReserve = A14; // relais ou electrovanne pour remplissage reserve
const uint8_t pinOutRAC = A15; // relais ou electrovanne pour RAC
...
const uint8_t pinOutEclairage[4] {8, 9, 7, 10}; // sortie PWM eclairage Couleur1, color2, Couleur1, color2
...
const uint8_t pinInFlotteurReserveBas = 33; // entree flotteur niveau bas reserve d'eau (ferme si niveau bas reserve d'eau osmose)
...
const uint8_t pinInFlotteurReserveHaut = 43; // >>> non disponible sur le PCBouns v1.6
