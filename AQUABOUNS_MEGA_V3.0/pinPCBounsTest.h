#ifndef PinPCBounsTest_h
#define PinPCBounsTest_h
...
/*
   ...
   Affectation des pin correspondant a l'utilisation du shield pour arduino mega PCBouns TEST
...
const uint8_t pinOutRelaisRefuge = A12; // relais coupure refuge // ouvert = off
const uint8_t pinOutRelaisRemplissageReserve = A13; // relais ou electrovanne pour remplissage reserve
const uint8_t pinOutRAC = A14; // relais ou electrovanne pour RAC
//A15 non disponible sur le pcb
...
const uint8_t pinOutRelaisVentilateurRampe = 12; // relais ventilateur rampe
const uint8_t pinOutEclairage[4] {9, 10, 11, 0}; // sortie PWM eclairage Couleur1, color2, Couleur3, color4
