...
const uint8_t pinOutRelaisRefuge = A10; // relais refuge // ouvert = off
const uint8_t pinOutRAC = A11; // relais ou electrovanne pour RAC
...
const uint8_t pinInFlotteurReserveBas = 37; // entree flotteur niveau bas reserve d'eau (ferme si niveau bas reserve d'eau osmose)
...
const uint8_t pinInFlotteurReserveHaut = 0; // >>> non disponible sur le PCBouns v1.5
